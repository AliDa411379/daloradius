...
CREATE TABLE IF NOT EXISTS `node` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `mac` (`mac`)
) ENGINE=InnoDB AUTO_INCREMENT=57686 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='node database';
...
) ENGINE=InnoDB AUTO_INCREMENT=7706 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=7705 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE IF NOT EXISTS `radpostauth` (
  ...
  PRIMARY KEY (`id`),
  KEY `username` (`username`(32))
) ENGINE=InnoDB AUTO_INCREMENT=7461 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Complete audit trail for all balance transactions';
...
DELIMITER //
CREATE DEFINER=`bassel`@`%` TRIGGER radacct_billing_delete
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE DEFINER=`bassel`@`%` TRIGGER radacct_billing_insert
...
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE DEFINER=`bassel`@`%` TRIGGER radacct_billing_update
