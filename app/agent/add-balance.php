...
/*
 *********************************************************************************************************
 * daloRADIUS - AGENT PORTAL - ADD BALANCE
 ...
 */
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (array_key_exists('csrf_token', $_POST) && isset($_POST['csrf_token']) && dalo_check_csrf_token($_POST['csrf_token'])) {
            ...
            $add_notes = (array_key_exists('add_notes', $_POST) && !empty(trim($_POST['add_notes'])))
                       ? trim($_POST['add_notes']) : "Balance added by agent";
    ...
    $title = "Add Balance";
    $help = "Add prepaid balance credit to your user accounts.";
        ...
        <div class="col-md-8 offset-md-2">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted">Add prepaid balance credit to your user accounts.</p>
                </div>
                    ...
                    <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" id="balanceForm">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="add_notes" 
                                      id="add_notes" 
                                      class="form-control" 
                                      rows="3"><?php echo isset($add_notes) ? htmlspecialchars($add_notes) : 'Balance added by agent'; ?></textarea>
                        </div>
                        ...
                        <div class="alert alert-info">
                            No users found. Please contact administrator.
                        </div>
                        <a href="index.php" class="btn btn-secondary">Back</a>
                        <?php endif; ?>
